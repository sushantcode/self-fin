...
const AddIncome = () => {
    ...
    const [setAddData, error, uploading] = useUploadRecord(tableNames.INCOME, newIncome);
    ...
    return (
        <div>
            <Card>
                <Card.Header className="text-center fs-4">Enter details of the income?</Card.Header>
                <Card.Body>
                    <Form className="mt-3">
