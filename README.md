...
- All data are locally encrypted before sendng to cloud (DDB) using combination keys and salts to reduce the possiblity of exposing data from cloud if by chance hacked by hacker.
